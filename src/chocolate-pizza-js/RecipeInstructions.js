...
export default class RecipeInstructions extends Component {
    render() {
        return (
            <div >
                <p className="article-a">For the fig-swirl: Melt butter over medium heat in a saucepan. Add brown sugar and stir to dissolve. Halve all
                ...
                <p className="article-b">Ice cream: In a small pot over medium heat, combine milk, and granulated sugar until sugar is completely
                dissolved and the milk is barely lukewarm.Whisk in the egg yolks.Set mixture in the fridge and wait until the
            fig mixture is cooled.</p >
                <p className="article-c"> Using an ice cream machine, pour liquids in the frozen basin and process according to manufacturer
